...
export async function rotasAuth(app: FastifyInstance): Promise<void> {
  ...
  app.post('/auth/registrar', {
    ...
    schema: doc({
      ...
      descricao:
        'Uma chamada monta o tenant inteiro: admin, 6 categorias e as 4 politicas de SLA padrao. ' +
  ...
  app.post('/auth/login', {
    ...
    schema: doc({
      ...
      descricao:
        'O 401 usa a mesma mensagem para e-mail inexistente, senha errada e conta desativada. ' +
  ...
  app.get('/usuarios', {
    ...
    schema: doc({
      ...
      descricao:
        'Alimenta o seletor de responsavel e os avatares do card. Inclui desativados: ' +
  ...
  app.patch('/auth/senha', {
    ...
    schema: doc({
      ...
      descricao:
        'Exige a senha atual mesmo com o token na mao: sem isso, um token roubado viraria ' +
