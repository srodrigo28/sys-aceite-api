...
await app.register(swagger, {
    openapi: {
        ...
        info: {
            title: 'SysAceite API',
            description: 'API para controle de ordens de servico, SLA, Kanban e aprovacao por link.',
            version: '0.1.0',
        },
        servers: [
...
app.get('/health', {
    schema: doc({
        ...
        descricao: 'Banco fora do ar responde 200 com `banco.conectado: false`. Um 500 aqui seria ' +
...
app.get('/healthz', {
    schema: doc({
        ...
        descricao: 'E o caminho que a sonda do deploy consulta. 200 aqui significa exatamente uma coisa: ' +
