...
const VALIDADES = { '24h': 24, '7d': 24 * 7, '30d': 24 * 30, sem_expiracao: null };
...
export async function rotasAprovacao(app) {
    ...
    app.post('/os/:id/links', {
        schema: doc({
            ...
            descricao: 'O token **e** o segredo: quem tem a URL aprova, sem login e sem conta. Por isso a ' +
    ...
    app.post('/links/:linkId/revogar', {
        schema: doc({
            ...
            descricao: 'Mata o token na hora: quem abrir depois ve a tela de link revogado. So funciona em link ' +
