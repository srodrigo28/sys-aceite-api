...
export async function rotasGrupos(app) {
    ...
    app.get('/grupos', {
        schema: doc({
            ...
            descricao: 'Grupo organiza o time — campo, escritorio, plantao — e **nao concede acesso nenhum**: ' +
    ...
    app.delete('/grupos/:id', {
        ...
        schema: doc({
            ...
            descricao: 'As pessoas continuam no workspace: o cascade leva apenas os vinculos. Como grupo nao da ' +
    ...
    app.put('/grupos/:id/membros', {
        ...
        schema: doc({
            ...
            descricao: 'E PUT com o estado final, nao POST/DELETE por pessoa, e isso e deliberado: arrastar ' +
