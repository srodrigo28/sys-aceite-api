...
import { categoriaSchema as categoriaResposta, politicaSchema as politicaResposta, uuidParam, } from '../lib/esquemas.js';
...
const painelSchema = z.object({
    ...
    padroes: z
        .record(z.string(), z.object({ minutosPrimeiraResposta: z.number().int(), minutosResolucao: z.number().int() }))
...
export async function rotasSla(app) {
    ...
    app.get('/sla', {
        schema: doc({
            ...
            descricao: 'Leitura aberta a todo o tenant de proposito: quem recebe o card precisa entender de ' +
    ...
    app.post('/sla/politicas', {
        ...
        schema: doc({
            ...
            descricao: 'Deixar `categoriaId` e `nivel` nulos cria a regra geral daquela prioridade. Preenche-los ' +
    ...
    app.patch('/sla/politicas/:id', {
        ...
        schema: doc({
            ...
            descricao: 'Vale imediatamente para as O.S. ja abertas: o SLA e calculado na leitura, nunca gravado. ' +
    ...
    app.delete('/sla/politicas/:id', {
        ...
        schema: doc({
            ...
            descricao: 'Sem a regra especifica, as O.S. que a usavam passam a cair na mais generica. Se nem essa ' +
    ...
    app.post('/sla/categorias', {
        ...
        schema: doc({
            ...
            descricao: 'O `multiplicadorSla` estica ou encurta o prazo da politica: 1.5 da 50% a mais para ' +
    ...
    app.delete('/sla/categorias/:id', {
        ...
        schema: doc({
            ...
            descricao: 'As O.S. da categoria ficam com `categoriaId: null` e passam a usar o prazo sem ' +
