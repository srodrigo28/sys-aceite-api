...
import { anexos, categorias, checklistItens, comentarios, historico, linksAprovacao, ordensServico, politicasSla, projetos, } from '../db/schema.js';
...
async function buscarDoTenant(id, tenantId) {
